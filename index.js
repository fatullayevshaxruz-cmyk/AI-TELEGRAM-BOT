...
bot.on("message", async msg => {
  ...
  if (text === "📘 Tarjima") {
    ...
    return bot.sendMessage(chatId, "📘 Tarjima rejimi yoqildi. Matn yuboring!");
  }
...
🚀 Start speaking now!`
  ...
  if (userMode[chatId] === "translate") {
    systemPrompt = "Translate the text to English and explain briefly in Uzbek if needed.";
  }
